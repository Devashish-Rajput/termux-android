...
```bash
curl -sL https://raw.githubusercontent.com/Devashish-Rajput/termux-android/main/install.sh | bash
```
**Or using wget:**
```bash
wget -O - https://raw.githubusercontent.com/jDevashish-Rajput/termux-android/main/install.sh | bash
```
---
## ✨ Features
| Feature | Description |
